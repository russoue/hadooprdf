...
public class HadoopElement  
{
	...
	public static enum HElementType { FILTER, BASIC, OPTIONAL, UNION };
	
	private  HElementType elementType = HElementType.BASIC;	
	
	public void setPrefixMap (String key, String value) { prefixMap.put(key, value); }
	
	public String getNsPrefix (String key) { return prefixMap.get(key); }
	
	public Set<String> getNsPrefixKey () { return prefixMap.keySet(); }
	...
	public HadoopElement (Element element) throws UnhandledElementException 
	{
		...
		if (element instanceof ElementGroup) { throw new UnhandledElementException("Element of this type is currently not handled"); } 
		else if (element instanceof ElementOptional) { elementType = HElementType.OPTIONAL; } 
		else if (element instanceof ElementTriplesBlock) { elementType = HElementType.BASIC; } 
		else { throw new UnhandledElementException("Element of this type is currently not handled"); }								
	}
	...
	public static ArrayList <Triple> getTripleList (HadoopElement hElement) { return null; }
	
	public HElementType elementType () { return elementType; }
	...
	public static class HadoopTriple extends Triple 
	{
		...
		public HadoopTriple (Node subject, Node predicate, Node object) { super (subject, predicate, object); }
		...
		public void addFile (String filePath) { filesAssociated.add(filePath); }
		
		public void addFiles (List<String> filesPath) { filesAssociated.addAll(filesPath); }
	
		public List<String> getAssociatedFiles () throws Exception 
		{	
			if (filesAssociated.size() == 0) { throw new Exception ("No associated files associated"); }
