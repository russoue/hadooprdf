...
public class QueryParser {
	...
	public static edu.utdallas.hadooprdf.query.parser.Query parseQuery (String queryString) throws UnhandledElementException {
		...
		edu.utdallas.hadooprdf.query.parser.Query q = new edu.utdallas.hadooprdf.query.parser.Query (eList, prefixMap);
