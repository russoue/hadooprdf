...
public class PredicateSplitterByObjectType extends PreprocessorJobRunner {
	...
	private void runJob1(edu.utdallas.hadooprdf.conf.Configuration config,
		...
		try {
			...
			job.setMapperClass(edu.utdallas.hadooprdf.preprocessing.predicateobjectsplit.mapred.PredicateSplitterByObjectTypeJob1Mapper.class);
			job.setReducerClass(edu.utdallas.hadooprdf.preprocessing.predicateobjectsplit.mapred.PredicateSplitterByObjectTypeJob1Reducer.class);
	...
	private void runJob2(edu.utdallas.hadooprdf.conf.Configuration config,
		...
		try {
			...
			// Set the mapper and reducer classes
			job.setMapperClass(edu.utdallas.hadooprdf.preprocessing.predicateobjectsplit.mapred.PredicateSplitterByObjectTypeJob2Mapper.class);
